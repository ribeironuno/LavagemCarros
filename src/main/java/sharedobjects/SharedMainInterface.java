...
public class SharedMainInterface {
    ...
    public enum Notificacao {
        VALOR_INSUFICIENTE, LAVAGEM_ACEITE_COM_TROCO, LAVAGEM_ACEITE_SEM_TROCO, CHEGOU_PRIMEIRO_CARRO, SEM_CARROS,
        RETIRADA_CARRO_COM_DEVOLUCAO, RETIRADA_CARRO_SEM_DEVOLUCAO, FECHO_COM_DEVOLUCAO, FECHO_SEM_DEVOLUCAO,
        RETOMAR_SISTEMA, SUSPENDER, TIRAR_SUSPENCAO;
    }
